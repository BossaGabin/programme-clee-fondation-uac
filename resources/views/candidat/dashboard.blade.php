    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container">
                                                    ...
                                                    <form method="POST"
                                                        ...
                                                        <div class="modal-body px-3 px-sm-4">
                                                            ...
                                                            <p class="text-muted mb-3">
                                                                ...
                                                                affecter le coach le plus adapté.
                                                            </p>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="parcours_professionnel"
                                                                    ...
                                                                    Votre parcours professionnel <span
                                                                        class="text-danger">*</span>
                                                                </label>
                                                                <textarea id="parcours_professionnel" name="parcours_professionnel"
                                                                    class="form-control @error('parcours_professionnel') is-invalid @enderror" style="height:120px;"
                                                                    placeholder="Je suis [Prénom Nom], titulaire d'un [niveau d'étude] en [domaine]. J'ai [X] ans d'expérience dans [secteur d'activité]. Mes principales compétences sont [compétence 1], [compétence 2] et [compétence 3]. Actuellement [situation actuelle], je souhaite [objectif professionnel] afin de [ambition à court/moyen terme].">{{ old('parcours_professionnel') }}</textarea>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="font-weight-bold">
                                                                    Option d'accompagnement choisi <span
                                                                        class="text-danger">*</span>
                                                                </label>
                                                                <div class="d-flex flex-wrap" style="gap:15px;">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="mode_presentiel"
                                                                            name="mode_entretien" value="presentiel"
                                                                        ...
                                                                        <label class="custom-control-label"
                                                                            for="mode_presentiel">
                                                                            <i
                                                                                class="fas fa-map-marker-alt mr-1 text-success"></i>
                                                                            Présentiel
                                                                        </label>
                                                                    </div>
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="mode_en_ligne"
                                                                            name="mode_entretien" value="en_ligne"
                                                                            class="custom-control-input"
                                                                        ...
                                                                        <label class="custom-control-label"
                                                                            for="mode_en_ligne">
                                                                            <i
                                                                                class="fas fa-video mr-1 text-primary"></i>
                                                                            En ligne
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div id="bloc_en_ligne"
                                                                style="{{ old('mode_entretien') === 'en_ligne' ? '' : 'display:none;' }}">
                                                                <div class="form-group">
                                                                    <label class="font-weight-bold">
                                                                        Plateforme en ligne <span
                                                                            class="text-danger">*</span>
                                                                    </label>
                                                                    <div class="d-flex flex-wrap" style="gap:15px;">
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio"
                                                                                id="plateforme_whatsapp"
                                                                                name="plateforme_enligne"
                                                                                value="whatsapp"
                                                                                class="custom-control-input"
                                                                                {{ old('plateforme_enligne') === 'whatsapp' ? 'checked' : '' }}
                                                                                onchange="togglePlateforme('whatsapp')">
                                                                            <label class="custom-control-label"
                                                                                for="plateforme_whatsapp">
                                                                                <i
                                                                        ...
                                                                        <div class="custom-control custom-radio">
                                                                            <input type="radio" id="plateforme_meet"
                                                                                name="plateforme_enligne"
                                                                                value="google_meet"
                                                                                class="custom-control-input"
                                                                            ...
                                                                            <label class="custom-control-label"
                                                                                for="plateforme_meet">
                                                                                <i
                                                                                    class="fas fa-video mr-1 text-danger"></i>
                                                                                Google Meet
                                                                            </label>
                                                                        </div>
                                                                        <div class="custom-control custom-radio">
                                                                            ...
                                                                            <label class="custom-control-label"
                                                                                for="plateforme_appel">
                                                                                <i
                                                                                    class="fas fa-phone mr-1 text-info"></i>
                                                                                Appel direct
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                {{-- Numéro WhatsApp --}}
                                                                <div id="bloc_whatsapp"
                                                                    style="{{ old('plateforme_enligne') === 'whatsapp' ? '' : 'display:none;' }}">
                                                                    <div class="form-group">
                                                                        <label for="numero_whatsapp"
                                                                            class="font-weight-bold">
                                                                            <i
                                                                                class="fab fa-whatsapp mr-1 text-success"></i>
                                                                            Numéro WhatsApp <span
                                                                                class="text-danger">*</span>
                                                                        </label>
                                                                        <input type="text" id="numero_whatsapp"
                                                                ...
                                                                {{-- Numéro appel direct --}}
                                                                <div id="bloc_appel"
                                                                    style="{{ old('plateforme_enligne') === 'appel_direct' ? '' : 'display:none;' }}">
                                                                    <div class="form-group">
                                                                        <label for="numero_appel"
                                                                            class="font-weight-bold">
                                                                            <i class="fas fa-phone mr-1 text-info"></i>
                                                                            Numéro joignable <span
                                                                                class="text-danger">*</span>
                                                                        </label>
                                                                        <input type="text" id="numero_appel"
                                                                            name="numero_appel"
                                                                ...
                                                                {{-- Google Meet --}}
                                                                <div id="bloc_meet"
                                                                    style="{{ old('plateforme_enligne') === 'google_meet' ? '' : 'display:none;' }}">
                                                                    <div class="alert alert-info py-2">
                                                                        <i class="fas fa-info-circle mr-2"></i>
                                                                        Le coach vous enverra le lien Google Meet lors
                                                                        de la confirmation.
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        {{-- Footer avec boutons empilés sur mobile --}}
                        ...
                        <div class="col-12">
                            <div class="alert mb-0"
                                ...
                                <div class="d-flex align-items-center mb-3" style="gap:14px;">
                                    <div
                                        style="width:42px;height:42px;border-radius:50%;background:#1cc88a22;
                                    ...
                                    <div>
                                        <p class="mb-0 font-weight-bold" style="color:#1b5e20;">
                                            Votre coach
                                            <strong>{{ $proposalEnAttente->coachAssignment->coach->name }}</strong>
                                ...
                                <div class="mt-3 p-2" style="background:#fff; border-radius:6px;">
                                    ...
                                    @if ($proposalEnAttente->mode === 'presentiel')
                                        <small>📍 Présentiel —
                                            {{ $proposalEnAttente->location ?? 'Lieu à confirmer' }}</small>
                                    @else
                                        <small>
                ...
                {{-- ===== ENTRETIEN + PROGRESSION CÔTE À CÔTE ===== --}}
                @if ($interview)
                    @php
                        ...
                        $assignment = $candidat->candidatAssignment ?? null;
                        $scores = null;
                        ...
                        if ($assignment) {
                            ...
                            $tousA20 = collect($scores['current'])->every(fn($v) => $v === 20);
                        }
                    @endphp
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            align-items:center; justify-content:center;">
                                            <span
                                                style="color:#fff; font-size:20px; font-weight:bold; line-height:1.1;">
                                                {{ $noteFinale }}/20
                                            </span>
                                        ...
                                        <p class="mt-2 mb-1 font-weight-bold" style="color:{{ $scoreColor }};">
                                            {{ $scoreLabel }}
                                        </p>
                                        <div class="p-2 rounded d-inline-block"
                                            style="background:{{ $scoreColor }}18; border:1px solid {{ $scoreColor }}; font-size:11px;">
                                            <i class="fas fa-compass mr-1" style="color:{{ $scoreColor }};"></i>
                                    ...
                                    @foreach ($interview->scores->sortBy('competence.order') as $index => $score)
                                        ...
                                        <div class="mb-2">
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                ...
                                                <small class="font-weight-bold" style="color:{{ $color }};">
                                                    {{ $score->note }}/20
                                                </small>
                                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0">
                                        <i class="fas fa-chart-line text-success mr-2"></i> Ma Progression
                                    </h5>
                                    @if ($scores)
                                        @if ($tousA20)
                                            <span class="badge badge-success">
                                                <i class="fas fa-trophy mr-1"></i> Complète !
                                            </span>
                                        @else
                                            {{-- <span class="badge badge-primary">
                                                {{ $assignment->progressionUpdates->count() }} séance(s)
                                            </span> --}}
                                        @endif
                                    @endif
                                </div>
                                <div class="card-body">
                                    @if ($scores)
                                        ...
                                        <div class="row text-center mb-3">
                                            <div class="col-4">
                                                <small class="text-muted d-block"
                                                    style="font-size:10px;">Initial</small>
                                            ...
                                            <div class="col-4">
                                                <small class="text-muted d-block"
                                                    style="font-size:10px;">Actuel</small>
                                            ...
                                            <div class="col-4">
                                                <small class="text-muted d-block"
                                                    style="font-size:10px;">Progression</small>
                                                <span
                                        ...
                                        @foreach ($interview->scores->sortBy('competence.order') as $score)
                                            @php
                                                ...
                                                $color = $blocColorsKeyed[$order] ?? '#006b08';
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div
                                                    style="position:relative; height:12px; background:#e9ecef;
                                    border-radius:8px; overflow:hidden;">
                                        ...
                                        border-radius:8px 0 0 8px; z-index:1;">
                                                    ...
                                                    <div class="bar-candidat-{{ $blocKey }}"
                                                        style="position:absolute; top:0; left:0; height:100%;
                                        ...
                                        display:flex; align-items:center; justify-content:center; z-index:3;">
                                                        <small
                                                            style="font-size:10px; font-weight:bold; color:#fff;
                                            text-shadow:0 0 3px rgba(0,0,0,0.5);">
                                                ...
                                                <div class="d-flex justify-content-between mt-1">
                                                    ...
                                                    <small
                                                        style="font-size:10px; color:{{ $color }}; font-weight:bold;">
                                                        Actuel : {{ $current }}/20
                                                    </small>
                                                </div>
                                            </div>
                                    ...
                                    @else
                                        <div class="text-center py-5">
                                            ...
                                            <p class="text-muted mb-0">Aucune mise à jour de progression.</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
                ...
                @elseif($entretien && !$interview)
                    {{-- Entretien programmé mais pas passé --}}
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
            ...
            setTimeout(() => {
                @if (isset($scores) && $scores)
                    @foreach ($interview->scores->sortBy('competence.order') as $score)
                        ...
                        @if ($bKey)
                            (function() {
                                const b = document.querySelector('.bar-candidat-{{ $bKey }}');
