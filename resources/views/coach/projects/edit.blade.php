{{-- resources/views/coach/projects/edit.blade.php --}}
<!DOCTYPE html>
<html lang="fr">
<title>CLEE - Modifier le projet professionnel</title>
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">
                            <i class="fas fa-edit mr-2"></i> Modifier le projet professionnel
                        </h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card" style="border-left:4px solid #f4a900;">
                            <div class="card-body d-flex align-items-center justify-content-between"
                                style="gap:15px; padding:12px 20px;">
                                <div class="d-flex align-items-center" style="gap:12px;">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">Modification du projet professionnel</small>
                                    </div>
                                </div>
                                <span class="badge badge-warning" style="font-size:12px; padding:6px 12px;">
                                    <i class="fas fa-pencil-alt mr-1"></i> Modification
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-9">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('coach.projects.update', $candidat) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="titre_projet"
                                                    ...
                                                    value="{{ old('titre_projet', $project->titre_projet) }}">
                                                @error('titre_projet')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="secteur_cible"
                                                    ...
                                                    value="{{ old('secteur_cible', $project->secteur_cible) }}">
                                                @error('secteur_cible')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="poste_vise"
                                                    ...
                                                    value="{{ old('poste_vise', $project->poste_vise) }}">
                                                @error('poste_vise')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control" rows="4" placeholder="Décrivez le projet professionnel...">{{ old('description', $project->description) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="objectif_court_terme" class="form-control" rows="3" placeholder="Objectif à 3-6 mois...">{{ old('objectif_court_terme', $project->objectif_court_terme) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="objectif_long_terme" class="form-control" rows="3" placeholder="Vision à 1 an et plus...">{{ old('objectif_long_terme', $project->objectif_long_terme) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
