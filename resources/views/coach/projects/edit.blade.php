                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description"
                                                          ...
                                                          placeholder="Décrivez le projet professionnel...">{{ old('description', $project->description) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="objectif_court_terme"
                                                          ...
                                                          placeholder="Objectif à 3-6 mois...">{{ old('objectif_court_terme', $project->objectif_court_terme) }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="objectif_long_terme"
                                                          class="form-control" rows="3"
                                                          placeholder="Vision à 1 an et plus...">{{ old('objectif_long_terme', $project->objectif_long_terme) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
