...
<html lang="en" class="h-100" id="login-page1">
   ...
   <head>
      ...
      <title>CLEE - Changer le mot de passe</title>
      <!-- Favicon icon -->
                  ...
                  <div class="form-input-content">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <h4 class="text-center m-t-15">Changer le mot de passe</h4>
                           @if ($errors->any())
                           ...
                           @endif
                           <form class="m-t-30 m-b-30" method="POST" action="{{ route('password.store') }}">
                              @csrf
                              <input type="hidden" name="token" value="{{ $request->route('token') }}">
                              ...
                              <div class="text-center m-b-15 m-t-15 ">
                                 <button type="submit" class="btn"
                                    style="background: #006b08; border-color:#006b08">Sauvegarder</button>
                              </div>
                           </form>
                        </div>
                     </div>
